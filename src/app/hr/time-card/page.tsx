...
function TimeCardContent() {
  ...
  const handleClockAction = (type: TimeClockEntry['type']) => {
    ...
    toast({
      ...
      description: `${labels[type]} registrado com sucesso.`
    });
    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Registro de jornada diária.</p>
        </div>
